                        ...
                        >
                            ...
                            <div className='space-y-4'>
                                ...
                                <p className='text-gray-500 text-sm'>
                                    Please upload your official logo and cover image. These assets help represent your brand consistently across all platforms.
                                </p>
                            ...
                            <div className='space-y-4'>
                                ...
                                <p className='text-gray-500 text-sm'>
                                    Add links to the university's social media profiles.
                                </p>
                            ...
                            <div className='pt-4'>
                                <Button
                                    type='submit'
                                    className='w-full bg-krida-dark hover:bg-krida-dark/90'
                                >
                                    Create
                                </Button>
                            </div>
...
export default OnboardUniversity;
