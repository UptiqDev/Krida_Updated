...
// Update WalletAllocation type to include 'allocation' property
interface WalletAllocation {
    walletAddress: string;
    allocation: string; // Added to match the expected structure
}

// Update the type of 'wallets' in EntityData to match VestingEntityData
interface EntityData {
    type: string;
    percentage: string;
    wallets: WalletAllocation[]; // Adjusted to match VestingEntityData
}
...
const TokenDistributionForm = ({ onNext, onBack }: TokenDistributionFormProps) => {
    ...
    console.log("tokenDist",tokenDistribution);
    console.log("tokenData",onNext);
    ...
    const handleSaveVestingEntity = (entityData: EntityData) => {
    ...
    const totalAllocatedPercentage = vestingEntities.reduce((acc, entity) => acc + parseInt(entity.percentage), 0);
                                    ...
                                    <div className='mt-4'>
                                        ...
                                        {vestingEntities.map((entity, index) => (
                                            ...
                                            >
                                                ...
                                                <div className='flex items-center'>
                                                    <span className='mr-4'>
                                                        {entity.percentage}% ({entity.tokens} Tokens)
                                                    </span>
