...
const TokenCreationForm = ({ onNext }: TokenCreationFormProps) => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    // Create the token with the entered values
    setCurrentToken({
      id: "",
      ...
      price: "$ 1",
      image: image || "",
      transferFeePercentage: values.transferFeePercentage,
      maxTransferFee: values.maxTransferFee,
    });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Define the core details of your university's token.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Give token a name" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Example: TKN" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div>
              ...
              <div className="mt-2 flex items-center space-x-4">
                <div className="border border-dashed border-gray-300 rounded-md p-4 w-24 h-24 flex items-center justify-center">
                  {image ? (
                    <img src={image} alt="Token" className="max-w-full max-h-full" />
                  ) : (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" placeholder="2 UFT" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="flex space-x-4 pt-4">
              <Button className="bg-krida-dark text-white hover:bg-krida-dark/90 rounded-full" type="submit">Save and Proceed</Button>
              <Button className="bg-gray-100 rounded-full" type="button" variant="outline">
                Cancel
              </Button>
            </div>
          </form>
