...
const VestingEntityModal = ({ open, onClose, onSave, selectedEntityType }: VestingEntityModalProps) => {
  ...
  const [wallets, setWallets] = useState<WalletAllocation[]>([
    { walletAddress: "d8y/d8rgh9jh0987rj1g9us087", percentage: "50" },
    { walletAddress: "d8y/d8rgh9jh0987rj1g9us087", percentage: "50" }
  ]);
  ...
  const handleAddWallet = () => {
    setWallets([...wallets, { walletAddress: "", percentage: "" }]);
  };
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-6 py-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Link wallet and allocate percentage</label>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Select value={cliffDuration} onValueChange={setCliffDuration}>
                  <SelectTrigger className="w-full">
              ...
              <div>
                ...
                <Select value={cliffUnlockPercentage} onValueChange={setCliffUnlockPercentage}>
                  <SelectTrigger className="w-full">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-sm text-gray-500">Unlock Percentage</label>
                <Select value={vestingUnlockPercentage} onValueChange={setVestingUnlockPercentage}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select percentage" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Select value={vestingTimePeriod} onValueChange={setVestingTimePeriod}>
                  <SelectTrigger className="w-full">
