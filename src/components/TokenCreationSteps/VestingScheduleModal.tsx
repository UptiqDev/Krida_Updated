    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <div className="flex justify-between items-center">
          ...
          <DialogClose className="h-6 w-6 rounded-full hover:bg-gray-100 inline-flex items-center justify-center">
          </DialogClose>
        </div>
          ...
          <div className="bg-amber-50 p-4 rounded-md flex flex-col sm:flex-row items-start sm:items-center justify-between">
            <div className="flex items-center mb-3 sm:mb-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Your account is now active, and 23,000 UFT tokens are unlocked under your vesting schedule.</p>
              </div>
            </div>
            <Button onClick={handleClaimTokens} className="w-full sm:w-auto">Claim Tokens</Button>
          </div>
